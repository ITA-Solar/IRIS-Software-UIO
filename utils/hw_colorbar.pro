...
;       HW_COLORBAR, NCOLORS=100, POSITION=[0.15, 0.85, 0.95, 0.90]
;
...
;       30/04/13 Renamed hw_colorbar to avoid conflict with IDL
;            built-in function (as of version 8.0). VHH.
;       $Id: hw_colorbar.pro,v 1.2 2013/09/16 08:36:02 viggoh Exp $
;-
;
;###########################################################################
;
...
PRO HW_COLORBAR, BOTTOM=bottom, CHARSIZE=charsize, COLOR=color, DIVISIONS=divisions, $
   ...
   TICKNAMES=ticknames,keep_pos=keep_pos
...
IF KEYWORD_SET(vertical) THEN BEGIN
   ...
   ENDIF ELSE BEGIN
      if not keyword_set(keep_pos) then begin
