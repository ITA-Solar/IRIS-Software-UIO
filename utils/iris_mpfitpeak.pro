...
;     CM, 30 Mar 2009
;   copy from mpfitpek to iris_mpfitpeak to fix bug with parenthesis
;     (exchanged it with brackets), Martin Wiesmann, 24 Jan 2014
;
;  $Id: iris_mpfitpeak.pro,v 1.1 2014/01/24 15:08:45 mawiesma Exp $
;-
...
forward_function mpfit, mpfitfun, iris_mpfitpeak, mpfitpeak_gauss, $
...
function iris_mpfitpeak, x, y, a, estimates=est, nterms=nterms, $
